...
define ('IMS_EXPAND_ENDPOINT', 'http://openphacts.cs.man.ac.uk:9090/QueryExpander/expandXML?query=');
define ('CHEMSPIDER_ENDPOINT', 'http://ops.rsc.org/api/v1/JSON.ashx');
define ('IMS_MAP_ENDPOINT', 'http://openphacts.cs.man.ac.uk:9090/QueryExpander/mapBySetRDF')
?>
